...
## Port forwarding and tunneling <a id="port-forwarding-and-tunneling"></a>
...
#### Rinetd - Port forward/redirect <a id="rinetd---port-forwardredirect"></a>
...
### SSH Tunneling - Port forwarding on SSH <a id="ssh-tunneling---port-forwarding-on-ssh"></a>
...
### SShuttle <a id="sshuttle"></a>

```text
sshuttle -vr root@192.168.1.101 0/0
```

### Port forward with metasploit <a id="port-forward-with-metasploit"></a>
...
#### Ping-sweep the network <a id="ping-sweep-the-network"></a>
...
#### Scan each host <a id="scan-each-host"></a>
...
#### Attack a specific port <a id="attack-a-specific-port"></a>
